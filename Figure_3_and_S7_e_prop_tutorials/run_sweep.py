...
for c in cs:
    for w in ws:
        for sigma in sigmas:
            ...
            out_file = f'./results_run2/delayed_xor_results_c_{c}_w_{w}_sigma_{sigma}_n_{n}.pkl'
            plot_file = f'./results_run2/delayed_xor_results_c_{c}_w_{w}_sigma_{sigma}_n_{n}.png'
